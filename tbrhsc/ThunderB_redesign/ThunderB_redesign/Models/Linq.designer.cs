...
namespace ThunderB_redesign.Models
{
    ...
    partial void Insertvolshift(volshift instance);
    partial void Updatevolshift(volshift instance);
    partial void Deletevolshift(volshift instance);
    ...
    partial void Deletedoctor(doctor instance);
		...
		public System.Data.Linq.Table<volshift> volshifts
		{
			get
			{
				return this.GetTable<volshift>();
			}
		}
    ...
    partial void Onpage_orderChanging(int value);
    partial void Onpage_orderChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_page_order", DbType="Int NOT NULL")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.volshift")]
	public partial class volshift : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnemailChanging(string value);
    partial void OnemailChanged();
    partial void OnshiftdayChanging(string value);
    partial void OnshiftdayChanged();
    #endregion
		...
		public string shiftday
		{
			...
			set
			{
				...
				{
					this.OnshiftdayChanging(value);
					this.SendPropertyChanging();
					this._shiftday = value;
					this.SendPropertyChanged("shiftday");
					this.OnshiftdayChanged();
				}
			}
		}
    ...
    partial void Onprd_cat_idChanging(int value);
    partial void Onprd_cat_idChanged();
    partial void Onprd_img_urlChanging(string value);
    partial void Onprd_img_urlChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_prd_description", DbType="VarChar(250) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_prd_cat_id", DbType="Int NOT NULL")]
		public int prd_cat_id
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_prd_img_url", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string prd_img_url
		{
			get
			{
				return this._prd_img_url;
			}
			set
			{
				if ((this._prd_img_url != value))
				{
					this.Onprd_img_urlChanging(value);
					this.SendPropertyChanging();
					this._prd_img_url = value;
					this.SendPropertyChanged("prd_img_url");
					this.Onprd_img_urlChanged();
				}
			}
		}
